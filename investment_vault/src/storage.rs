...
// The extend_to is the new TNL set, chosen to cover the vault's intended lifetime (~10 years).
...
/// Bumps the TNL whenever the entry is accessed to keep it alive as long as the contract is in use.
